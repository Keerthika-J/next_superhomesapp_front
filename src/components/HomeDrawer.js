        ...
        <nav className='header-main'>
            ...
            <div className='w-full flex justify-between p-8'>
                <div className="w-12 md:w-16 h-12 md:h-16">
                    <Link href="/"><img className="cursor-pointer" src="/images/logo-white.png" alt="Logo" ></img></Link>
                </div>
                <div className="hidden md:block">
                    <button className="menu-button-white" onClick={toggleDrawer}>
                        <img src="/images/hamburger-icon.png" alt="Hamburger icon" className="w-6 h-4 inline"></img>
                        <div className="">
                ...
                <div className="flex md:hidden">
                    <button className="menu-button rounded-full" onClick={toggleDrawer}><img src="/images/hamburger-icon.png" alt="Hamburger icon" className="w-10 h-6 invert"></img></button>
                </div>
            </div>
        </nav>
    );
